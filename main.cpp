...
int stateCloud1 = -1, stateCloud2 = -1, stateSun = 1, stateBoat = 1;
float x_cloud1 = 0, x_cloud2 = -50, x_sun = 180, x_boat = 120, y_boat=75;

void init(void){
	glClearColor(0.44, 0.63, 0.88, 0.0);	// Set display window colour to white
...
void Green(int xAxis, int yAxis){
    ...
    glBegin(GL_POLYGON);
        ...
        glVertex2i(x_green+2,y_green+10);
        glVertex2i(x_green+4,y_green+5);
        glVertex2i(x_green+6,y_green+20);
        glVertex2i(x_green+8,y_green+5);
        glVertex2i(x_green+10,y_green+15);
        glVertex2i(x_green+12,y_green+3);
        glVertex2i(x_green+14,y_green+23);
        glVertex2i(x_green+16,y_green+0);
    glEnd();
}

void Green2(int xAxis, int yAxis){
    int x_green2=xAxis, y_green2=yAxis;

    ///Tree
    glColor3ub(34,139,34);
    glBegin(GL_POLYGON);
        glVertex2i(x_green2+0,y_green2+0);
        glVertex2i(x_green2+3,y_green2+25);
        glVertex2i(x_green2+6,y_green2+5);
        glVertex2i(x_green2+9,y_green2+35);
        glVertex2i(x_green2+12,y_green2+5);
        glVertex2i(x_green2+13,y_green2+30);
        glVertex2i(x_green2+20,y_green2+15);
        glVertex2i(x_green2+21,y_green2+40);
        glVertex2i(x_green2+32,y_green2+0);
        glVertex2i(x_green2+32,y_green2+35);
        glVertex2i(x_green2+40,y_green2+0);
        glVertex2i(x_green2+0,y_green2+0);
    glEnd();
}
...
int main(int argc, char* argv[])
{
	...
	glutInitWindowPosition(50, 65);				// Set window position
	glutInitWindowSize(1200, 700);					// Set window size
	glutCreateWindow("171-15-9365");	// Create display window
	init();							// Execute initialisation procedure
	glutDisplayFunc(AbdullahAlAmin);		// Send graphics to display window
